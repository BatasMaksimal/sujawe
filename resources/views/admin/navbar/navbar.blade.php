...
<nav class="navbar navbar-expand-lg">
    <div class="container">
        <a class="navbar-brand mt-2" href="#"><img src="../user/images/Roc_Nation_logo.png" alt="" width="190px"
                height="35px"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ms-auto">
                <li class="nav-item">
                    <a class="nav-link d-flex justify-center align-items-center mx-2"><i
                            class="far fa-user-circle mx-2"></i><?= $_SESSION['username'] ?></a>
                </li>
